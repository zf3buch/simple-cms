...
namespace PageFrontendTest;

use PageFrontend\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('PAGE_FRONTEND_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(PAGE_FRONTEND_MODULE_ROOT)
        );
    }
