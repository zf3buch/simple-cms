...
namespace CategoryBackendTest;

use CategoryBackend\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('CATEGORY_BACKEND_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(CATEGORY_BACKEND_MODULE_ROOT)
        );
    }
